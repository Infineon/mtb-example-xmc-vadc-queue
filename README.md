...
This example uses four analog input channels. Table 1 and 2 show the analog module connections in XMC1400 and XMC4700 kits.

**Table 1. Analog Module Connections in XMC1400 Boot Kit**
...
**Table 1. Analog Module Connections in XMC4700 Relax Kit**
...
The queue FIFO is configured with Channels 0, 1, 3, and 5 in the firmware. Channel 1, 3, and 5 are configured as refill, so the queue will be fed again with these channels after the first conversion. Channel 0 is configured as 'no refill' and to produce an interrupt after finishing its conversion. Channel 0 and 1 are configured with external trigger enabled. The Capture and Compare Unit 4 (CCU4) is used to trigger the queue periodically. The ADC results will be displayed on UART Terminal.
...
Document Title: *CE232709* - *XMC MCU: VADC Queue*
